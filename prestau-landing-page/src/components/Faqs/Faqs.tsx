...
const Faqs = () => {
  return (
    <main id="main-content">
      <img
        src={getImage("faqs-image.png")}
        alt="no image"
        className="faqs-waves"
      />
      <img
        src={getImage("faqs-right.png")}
        alt="no image"
        className="faqs-waves2"
      />
      <Container>
        <div className="content">
          <div className="main-content-top-section">
            ...
            <div className="right-section">
              <img src={getImage("faqs-image.png")} alt="no image" />
            </div>
          </div>
            ...
            <Row>
              <Col sm>
                ...
                <p className="agility">
                  ...
                  <ol className="regulation-points">
                    <li>
